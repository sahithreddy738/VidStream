  ...
  return (
    <div className="w-full flex flex-col space-y-2 mb-8">
      ...
      <div className="flex flex-row items-center justify-between w-full">
        <div className="flex flex-row space-x-2 w-[50%] items-center ">
        ...
        <div className="flex flex-row w-[50%] justify-end space-x-4 font-semibold">
          <div>
            <button className="rounded-l-2xl bg-blue-400 px-4 py-2 border-r-2 border-black">
              {(likeCount / 1000000).toFixed(1) + "M"} 👍
            </button>
            <button className="rounded-r-2xl bg-blue-400 px-4 py-2">
              1k👎
            </button>
          </div>
