...
export const YOUTUBE_SEARCH_RESULTS_URL1="https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=";
export const YOUTUBE_SEARCH_RESULTS_URL2="&key="+YOUTUBE_KEY;
export const YOUTUBE_COMMENTS_URL1="https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&videoId=";
